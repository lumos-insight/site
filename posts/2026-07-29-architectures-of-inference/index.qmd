---
title: "Architectures of Inference"
subtitle: "Institutions, Assurance, and What Happens When Models Become Assessors"
description: "From a lecture on Britain's AI future to the psychometrics of LLM raters — on why the harder problem is not building capable models but building the institutions that can judge what their outputs actually mean"
date: 2026-07-29
draft: false
categories: [AI, Governance, Psychometric validation]
tags: [ai-assurance, psychometrics, validation, evaluation, institutions, education, llm-raters, automated-scoring, governance, measurement]
canonical-url: https://www.lumosinsight.co.uk/posts/2026-07-29-architectures-of-inference/
cover-image: header.png
cover-image-alt: "Vast domed hall lit by a shaft of light through a central oculus, with a suspended sphere of golden wires above tiny figures at a reflecting pool"

open-graph:
  title: "Architectures of Inference"
  description: "From a lecture on Britain's AI future to the psychometrics of LLM raters — on why the harder problem is not building capable models but building the institutions that can judge what their outputs actually mean"
  image: https://www.lumosinsight.co.uk/posts/2026-07-29-architectures-of-inference/header.png
  image-alt: "Vast domed hall lit by a shaft of light through a central oculus, with a suspended sphere of golden wires above tiny figures at a reflecting pool"
  site-url: https://www.lumosinsight.co.uk/posts/2026-07-29-architectures-of-inference/
...
The autoregressive multi-trait scoring approach proposed by Do, Kim and Lee[^4] treats the task differently. Rather than framing essay assessment as ordinary regression or classification, it reframes scoring as sequence generation. A single language model generates several trait scores as an ordered sequence, with each later prediction able to condition on the scores already produced.
...
[^1]: *The Future of AI* with Sir Demis Hassabis and Dame Wendy Hall, the Worshipful Company of Information Technologists' annual lecture. <https://www.youtube.com/watch?v=HlLa5iA8lOs>

[^2]: Department for Science, Innovation and Technology. *Introduction to AI assurance* (February 2024). <https://www.gov.uk/government/publications/introduction-to-ai-assurance/introduction-to-ai-assurance>

[^3]: Stockdale, K., Hickman, L., & Liu, S. (2026). Scoring employment interviews with large language models: Evaluation design components, validity investigations, and best practice recommendations. *Journal of Applied Psychology*. <https://doi.org/10.1037/apl0001396>

[^4]: Do, H., Kim, Y., & Lee, G. G. (2024). *Autoregressive Score Generation for Multi-trait Essay Scoring*. <https://arxiv.org/abs/2403.08332>

[^5]: Demis Hassabis on *Culture* by Iain M. Banks, Recommentions. <https://recommentions.com/demis-hassabis/books/culture-by-iain-banks/>
